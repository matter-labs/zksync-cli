...
function default_1() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(`Confirms the withdrawal of funds from zkSync to Layer 1. It will prompt for the network type (testnet, mainnet, localnet), the transaction address of the withdrawal, and the private key of the wallet initiating the confirmation.\n`);
